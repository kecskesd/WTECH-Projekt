<nav id="mobile-nav">
    ...
    <a class="nav-black" href="{{route('shop', ['collection' => 'On Sale'])}}">ON SALE</a>
    <a class="nav-black" href="{{route('shop', ['collection' => 'New Releases'])}}">NEW RELEASES</a>
    <a class="nav-black" href="{{route('shop')}}">ALL SNEAKERS</a>
    @if(Request::is('shop'))
